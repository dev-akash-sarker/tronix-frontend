...
const fetchCategoryProducts = async (): Promise<ProductInterface[]> => {
...
export default function CategoryNamePage({ params }: Props) {
  ...
  return (
    <div>
      <h4 className=" -mt-4  text-hover-social text-lg mb-4">
        <Link
          href="/"
          className=" inline-block hover:text-social transition-all"
        >
          Home
        </Link>
        ...
        <Link
          ...
          className=" inline-block text-social hover:text-hover-social transition-all"
        >
          {categoryname}
        </Link>
      </h4>
          ...
          <div className="border border-gray-300 rounded-md" key={index}>
            ...
            <div className="text-center my-4">
              ...
              <div className="flex items-center justify-center gap-4 mt-4">
                ...
                <p className="font-bold text-xl">{product.rating}</p>
