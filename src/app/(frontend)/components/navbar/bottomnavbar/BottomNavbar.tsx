                  ...
                  <div className="absolute w-full bg-gray-200 max-h-[400px] z-20 top-14 rounded-[8px] px-2 overflow-y-scroll">
                    <div className="py-2">
                      ...
                      {filteredProducts.map((product , i) => (
                        <div className=" flex gap-x-2 items-center justify-between" key={i}>
                    ...
                    {cartAll.length !== 0 ? (
                      <>
                        ...
                        <div className=" p-8">
                          ...
                          <Link href={'/cart/checkout'} onClick={() => setIscartopen(false)}  className=" w-full  my-4 block text-center py-4 bg-hover-social rounded-2xl text-white font-pop font-normal text-lg">
                            Checkout
                          </Link>
                          <center>
                            <button
