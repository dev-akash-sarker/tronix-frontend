    ...
    <>
      <div className=" flex flex-col justify-center xl:flex-row  xl:justify-between items-center">
        <div className="flex justify-between items-center mx-8">
          ...
          <div className="relative w-20 h-20 lg:w-16 lg:h-16 xl:w-20 xl:h-20">
            <Image
              src="/newslettere.svg"
              fill
              alt="newslettericon"
        ...
        <div>
          <input
            ...
            className=" min-[374px]:w-90.5 mx-2 sm:w-[320px] md:w-120 md:mt-3 lg:mt-0 px-8 pt-6 pb-6.25 outline-none bg-white rounded-lg"
          />
