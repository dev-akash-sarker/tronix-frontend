...
const fetchTopRatedProducts = async (): Promise<ProductInterface[]> => {
  ...
  return ratedProducts.sort((a, b) => (b.averageRating ?? 0) - (a.averageRating ?? 0));
};
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {toprated?.map((product) => (
          <div className="border border-gray-300 rounded-md" key={product._id}>
            <div className="m-4 w-[413px] h-[313px] rounded-md overflow-hidden">
              <Image
            ...
            <div className="text-center my-4">
              ...
              <div className="flex items-center justify-center gap-4 mt-4">
                ...
                <p className="font-bold text-xl">{(product.averageRating ?? 0).toFixed(1)}</p>
